...
int main() {
  ...
  el = (t_list *)0;
  print("sorted list1 is :");
  t_list *boys = ft_create_elem((void*)ft_strdup("Jack"));
  ft_list_push_back(&boys, (void *)ft_strdup("Johnny"));
  ft_list_push_back(&boys, (void *)ft_strdup("Ernest"));
  ft_list_push_back(&boys, (void *)ft_strdup("Billy"));
  ft_list_push_back(&boys, (void *)ft_strdup("Linus"));
  ft_list_push_back(&boys, (void *)ft_strdup("Richard"));
  ft_list_push_back(&boys, (void *)ft_strdup("Bob"));
  ft_list_sort(&boys, ft_strcmp);
  printList(boys);
  print("sorted list2 is :");
  t_list *girls = ft_create_elem((void*)ft_strdup("Ella"));
  ft_list_push_back(&girls, (void *)ft_strdup("Billie"));
  ft_list_push_back(&girls, (void *)ft_strdup("Pamela"));
  ft_list_push_back(&girls, (void *)ft_strdup("Jodie"));
  ft_list_push_back(&girls, (void *)ft_strdup("Zoe"));
  ft_list_push_back(&girls, (void *)ft_strdup("Alice"));
  ft_list_push_back(&girls, (void *)ft_strdup("Eva"));
  ft_list_push_back(&girls, (void *)ft_strdup("Eve"));
  ft_list_push_back(&girls, (void *)ft_strdup("Suzy"));
  ft_list_push_back(&girls, (void *)ft_strdup("Suzanne"));
  ft_list_sort(&girls, ft_strcmp);
  printList(girls);
  print("sorted merged list is :");
  ft_sorted_list_merge(&boys, girls, ft_strcmp);
  printList(boys);
  ft_list_clear(boys, free);
}
